...
class FifaBrowser(object):
    ...
    def search(self, min_price = None, max_price = None, min_buy = None, max_buy = None, quality = None, id = 0):
        ...
        # maskedDefId: item filter (int) Ronaldo = 20801
    ...
    def auth(self, nonce):
        ...
        # {"question":1,"attempts":5,"recoverAttempts":20} or {"debug":"Already answered question.","string":"Already answered question","code":"483","reason":"Already answered question.","token":"729041902826166730"}
        #
        ...
        r = self.br.open("https://www.easports.com/iframe/fut17/p/ut/game/fifa17/phishing/question?_="+str(nonce))
        response = json.loads(r)
        print response
        if 'question' in response:
            # Need to answer question
            print "Answering Question"
            r = self.br.open("https://www.easports.com/iframe/fut17/p/ut/game/fifa17/phishing/validate", "answer="+SECURITY_ANSWER_HASH).read()
            print r
        else:
    ...
    def afterLoginSequence(self):
        ...
        for i in range(len(routes)):
            # Changes X-UT-Route
            self.iframeHeaders['X-UT-Route'] = routes[i]
            self.iframebr.addheaders = self.iframeHeaderList()
            print "https://www.easports.com/iframe/fut17/p/ut/game/fifa17/user/accountinfo?filterConsoleLogin=true&sku=FUT17WEB&returningUserGameYear=2016&_="+str(nonce + i)
            r = self.iframebr.open("https://www.easports.com/iframe/fut17/p/ut/game/fifa17/user/accountinfo?filterConsoleLogin=true&sku=FUT17WEB&returningUserGameYear=2016&_="+str(nonce + i)).read()
            print r
            response = json.loads(r)
