...
# --Found out it comes from a js file here: https://gateway.ea.com/proxy/identity/pids/me
...
# -- Found it, calculated here: function submit() in 60a8e93.js
# -- Its a custom md5 hash with no salt
...
class FifaBrowser(object):
    ...
    def search(self,  reauth=True, min_price = None, max_price = None, min_buy = None, max_buy = None, quality = None, id = 0):
        ...
        for i in range(1, 2):
            ...
            url = self.route +"/ut/game/fifa17/transfermarket?"
            # Add search params
    ...
    def afterLoginSequence(self):
        ...
        if 'question' in response:
            ...
            if ("code" in response and response["code"] == "200"):
                ...
                print "Error, wrong security answer"
                return False
        else:
